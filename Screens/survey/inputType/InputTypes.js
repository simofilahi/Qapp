...
const DROPDROWN_MULTIPLECHOISES_INPUT = 0
const DROPDROWN_SINGLECHOISE_INPUT = 1
const RADIO_INPUT = 2
const CHECKBOX_INPUT = 3
const BOOLEAN_INPUT = 4
const STRING_INPUT = 5
const TEXTAREA_INPUT = 6
const INTEGER_INPUT = 7
const FLOAT_INPUT = 8
const DATETIME_INPUT = 9
const DATE_INPUT = 10
const TIME_INPUT = 11
